# escape=`
# ===========================================
# Windows Base Builder Image
# ===========================================
# This image contains all build dependencies for Rust projects on Windows
# It is built separately and rarely updated (only when build tools need updates)
# Used by: client-windows, server-windows, and other Windows build containers
# ===========================================
